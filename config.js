...
global.pairingNumber = process.env.BOT_NUMBER || 'your number';  
global.SESSION_ID = process.env.SESSION_ID || 'session id';  'iAJz0CTK#Z0botihXFluyZ00C9wAirPuVHF8YmZY4aHQxaDxSkog'
